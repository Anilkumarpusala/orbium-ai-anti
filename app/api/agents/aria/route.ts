...
export async function POST(req: Request) {
  try {
    ...
    if (provider === "gemini") {
      ...
      console.log("Aria / Gemini response:", JSON.stringify(json, null, 2));
      ...
      const json = await res.json();
      console.log("Aria / Claude response:", JSON.stringify(json, null, 2));
      ...
      const json = await res.json();
      console.log("Aria / OpenAI response:", JSON.stringify(json, null, 2));
      ...
      const json = await res.json();
      console.log("Aria / Ollama response:", JSON.stringify(json, null, 2));
