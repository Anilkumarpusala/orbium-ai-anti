...
export async function POST(req: Request) {
  try {
    ...
    if (provider === "gemini") {
      ...
      console.log("Rex / Gemini response:", JSON.stringify(json, null, 2));
      ...
      const json = await res.json();
      console.log("Rex / Claude response:", JSON.stringify(json, null, 2));
      ...
      const json = await res.json();
      console.log("Rex / OpenAI response:", JSON.stringify(json, null, 2));
      ...
      const json = await res.json();
      console.log("Rex / Ollama response:", JSON.stringify(json, null, 2));
    ...
    console.error("Rex agent error:", msg);
